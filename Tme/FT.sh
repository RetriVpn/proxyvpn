...
res1() {
    wget https://raw.githubusercontent.com/RetriVpn/inflating/vpnzip/inflating_vpn_dote_zip/menu.zip
...
# // USERNAME IZIN IPP
rm -f /usr/bin/user
username=$(curl -sS https://raw.githubusercontent.com/RetriVpn/REGISTER/main/IPVPS| grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
rm -f /usr/bin/e
valid=$(curl -sS https://raw.githubusercontent.com/RetriVpn/REGISTER/main/IPVPS| grep $MYIP | awk '{print $3}')
...
# // RETRI TUNNELING | RETRI PROJECT
# // WHATSAPP : 085141310066
# // TELEGRAM : RetriVpn
clear
...
echo -e "   \e[92;1m   .::::.${Suffix}\e[92;1m RETRI PROJECT .::::.${Suffix}"
echo -e "   \e[93;1m──────────────────────────────────────${Suffix}"
echo -e "       \e[93;1m┌───────────────────────────┐${Suffix}"
